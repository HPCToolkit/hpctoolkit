%% $Id: hpcprof-mpi.tex 2958 2010-07-20 04:09:11Z tallent $
...
\rcsInfo $Id: hpcprof-mpi.tex 2958 2010-07-20 04:09:11Z tallent $
...
\Prog{hpcprof-mpi} \emph{scalably} analyzes call path profile performance measurements and attributes them to static source code structure.  See \HTMLhref{hpctoolkit.html}{\Cmd{hpctoolkit}{1}} for an overview of \textbf{HPCToolkit}.

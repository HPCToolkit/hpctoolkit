...
\section{I get a message about ``unable to write to tmp directory''}

While profiling a program, \hpcrun{} must write some internal data to temporary files.
By default, these files are written to \verb|/tmp|. On some systems, however, you may not
have permission to write to \verb|/tmp|. If this is the case on your system, then
you will see the message
\begin{quote}
\begin{verbatim}
    hpcrun: unable to write to tmp directory: /tmp
    please set HPCRUN_TMPDIR or TMPDIR and try again
\end{verbatim}
\end{quote}

To correct this problem, you should set the \verb|HPCRUN_TMPDIR| (or, if you prefer, \verb|TMPDIR|)
...
See section~\ref{sec:env-vars} for a bit more detail.

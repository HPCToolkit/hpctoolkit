...
Verbose: generate progress messages to stderr at verbosity level \Arg{n}.  \{1\}  (Use n=2 to debug path replacement if metric and program structure is not properly matched.)

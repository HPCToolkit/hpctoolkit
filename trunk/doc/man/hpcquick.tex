...
\end{itemize}
For best results, two other options should be used: \textbf{-I} to provide paths for source code directories and \textbf{-S} to provide source code structure from \HTMLhref{bloop.html}{\Cmd{bloop}{1}}.
...
\item[\OptArg{-S}{struct-file}] A structure file (from \HTMLhref{bloop.html}{\Cmd{bloop}{1}}) for the main program and/or any or all of the shared libraries used by the program.  May be passed multiple times.

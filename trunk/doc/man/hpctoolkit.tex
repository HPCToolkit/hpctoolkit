...
\HTMLhref{bloop.html}{\Cmd{bloop}{1}} recovers static program structure such as procedures and loop nests.
...
\textbf{HPCToolkit}'s correlation tool combines dynamic profile information with \HTMLhref{bloop.html}{\Cmd{bloop}{1}}'s static program structure to correlate costs of the optimized object code to useful source code constructs such as loop nests.
The result of correlation is called an Experiment database.
Currently, \HTMLhref{hpcquick.html}{\Cmd{hpcquick}{1}}/\HTMLhref{hpcview.html}{\Cmd{hpcview}{1}} is used for flat profiles and \Cmd{xcsprof}{1} for call stack profiles.
...
\HTMLhref{hpcprof.html}{\Cmd{hpcprof}{1}} correlates `flat' profiles with procedure source line information.
...
\item \textbf{Recover static source code structure}. Use \HTMLhref{bloop.html}{\Cmd{bloop}{1}} to recover program structure.
\begin{verbatim}
  bloop zoo > zoo.psxml
\end{verbatim}
...
\HTMLhref{bloop.html}{\Cmd{bloop}{1}} \\
\HTMLhref{hpcquick.html}{\Cmd{hpcquick}{1}}, \HTMLhref{hpcview.html}{\Cmd{hpcview}{1}}, \Cmd{xcsprof}{1}, \HTMLhref{hpcprof.html}{\Cmd{hpcprof}{1}} \\ %\Cmd{xprof}{1} 

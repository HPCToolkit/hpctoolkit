...
The two metric types are
  \begin{itemize}
  \item \textbf{Native or FILE metrics}.  This metric is read from a file which can be of type HPCRUN (from \HTMLhref{hpcrun.html}{\Cmd{hpcrun}{1}}) or PROFILE (from \Cmd{hpcprof}{1}).

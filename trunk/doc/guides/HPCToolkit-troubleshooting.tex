...
\begin{comment}
  ...
  Best Practice: Carefully inspect the output of hpcprof to determine
  which ﬁles are lost. Then, specify one or more -I flags with paths
  to directories from which the relative paths of lost source files
  can be resolved. Specifying a -I path ending in a '*' (the recursive
  search form) can reduce the number of -I paths that need to be
  specified.
 ----------------
  From Nathan
  ...
  create cycles, this will be the right thing 99% of the time.
---
  John Again

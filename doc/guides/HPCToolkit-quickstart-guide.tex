...
\lindent
\verb|hpclink mpicc -o myprogram file.o ... -l<lib> ...| \\[1ex]
Then, set the {\tt HPCRUN\_EVENT\_LIST} environment variable in the
launch script before running the application. For instance, on a Cray XT, one could measure total cycles with a hardware performance counter as follows: \\
\lindent
\verb|export HPCRUN_EVENT_LIST="PAPI_TOT_CYC@4000000"| \\
\lindent
\verb|aprun -n 64 myprogram arg ...| \\[1ex]
See the {\it Using {\sc HPCToolkit} with Statically-Linked Programs} guide
for more information, such as the usage idioms for Blue Gene/P.
...
\lindent \lindent hpctoolkit-myprogram-measurements}\\
{\em or}\\
\lindent {\tt mpi-launcher... \verb+\+\\
\lindent hpcprof-mpi -S myprogram.hpcstruct -I path-to-myprogram-src/'*' \verb+\+ \\
\lindent \lindent hpctoolkit-myprogram-measurements}

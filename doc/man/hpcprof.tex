...
If {\Cmd{hpcstruct}{1}} was run on the measurements directory, no \textbf{-S} arguments are needed.
...
If  {\Cmd{hpcstruct}{1}} was run on the measurements directory, no such arguments are needed.

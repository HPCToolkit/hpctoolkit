...
\Prog{hpcprof} \oOpt{options} \Arg{executable} \Arg{hpcrun-file}...

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Description}

\Prog{hpcprof} correlates `flat' execution profiles of \Arg{executable} with source code files, procedures, lines or with object code.
It is typically used to generate plain-text or HTML output.

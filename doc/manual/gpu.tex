...
{
\centering
 \fbox{\parbox{\textwidth}{Note:  HPCToolkit provides initial support for measurement and analysis of GPU-accelerated applications on Intel GPUs. At the writing of this manual, HPCToolkit's support for Intel GPUs must be built manually because Intel does not yet provide {\tt spack} packages for Intel software that   HPCToolkit relies on. See \url{http://hpctoolkit.org/software-instructions.html} for directions about how to build HPCToolkit for Intel GPUs.}}
 \vspace{2ex}
}

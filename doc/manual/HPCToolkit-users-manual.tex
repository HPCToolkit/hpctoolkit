...
\title{\HPCToolkit{} User's Manual\\[.5in]Version 2021.05.15}
%\subtitle{}
...
To avoid this deadlock, Spectrum MPI provides a flag {\tt -disable\_gpu\_hooks} to disable the PAMI CUDA hook library.  
This flag cannot be used with the {\tt -gpu} flag. 

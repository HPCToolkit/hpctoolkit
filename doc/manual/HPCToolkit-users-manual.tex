...
\section{\hpcviewer{} throws so many error messages!}

Some error messages are due to incompatibility with Eclipse E4 layer used by \hpcviewer{}.
To remedy this issue, you should clear your \hpcviewer{} workspace  (usually in \texttt{\$HOME/.hpctoolkit/hpcviewer} directory, and run \hpcviewer{} again.

...
Rather than adding the redefinitions of these linker patterns to the {\tt cmake} command line, 
you may find it more convenient to add a definitions of these rules to your {\tt cmake} file.

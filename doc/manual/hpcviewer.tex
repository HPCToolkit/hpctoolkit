...
\item \textbf{Minimize/Maximize window}. Icons in the upper right corner of the window enable you to minimize (\includegraphics[scale=.8]{fig/Minimize.png}) or maximize (\includegraphics[scale=.8]{fig/Maximize.png}) the \hpcviewer{} window.
\end{itemize}

...
std::map<std::string, InstructionTypes> Instruction::opcode_types = {
  ...
  // sm_60
  { "CSET", INS_TYPE_OTHER },
  { "CSETP", INS_TYPE_OTHER },
  { "PSET", INS_TYPE_OTHER },
  // sm_70
  { "B2R", INS_TYPE_OTHER },
  { "BAR", INS_TYPE_OTHER },
  { "CS2R", INS_TYPE_OTHER },
  { "CSMTEST", INS_TYPE_OTHER },
  { "DEPBAR", INS_TYPE_OTHER },
  { "GETLMEMBASE", INS_TYPE_OTHER },
  { "LEPC", INS_TYPE_OTHER },
  { "NOP", INS_TYPE_OTHER },
  { "PMTRIG", INS_TYPE_OTHER },
  { "R2B", INS_TYPE_OTHER },
  { "S2R", INS_TYPE_OTHER },
  { "SETCTAID", INS_TYPE_OTHER },
  { "SETLMEMBASE", INS_TYPE_OTHER },
  { "VOTE", INS_TYPE_OTHER },
  { "VOTE_VTG", INS_TYPE_OTHER },
  { "F2F", INS_TYPE_OTHER },
  { "F2I", INS_TYPE_OTHER },
  { "I2F", INS_TYPE_OTHER },
  { "I2I", INS_TYPE_OTHER },
  ...
  { "FRND", INS_TYPE_OTHER },
  { "MOV", INS_TYPE_OTHER },
  { "MOV32I", INS_TYPE_OTHER },
  { "PRMT", INS_TYPE_OTHER },
  { "SEL", INS_TYPE_OTHER },
  { "SGXT", INS_TYPE_OTHER },
  { "SHFL", INS_TYPE_OTHER },
  { "PLOP3", INS_TYPE_OTHER },
  { "PSETP", INS_TYPE_OTHER },
  { "P2R", INS_TYPE_OTHER },
  { "R2P", INS_TYPE_OTHER },
  { "SUATOM", INS_TYPE_OTHER },
  { "SULD", INS_TYPE_OTHER },
  { "SURED", INS_TYPE_OTHER },
  { "SUST", INS_TYPE_OTHER }
};

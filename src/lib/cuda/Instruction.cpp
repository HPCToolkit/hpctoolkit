...
std::set<std::string> Instruction::opcode_jump = {{"BRA"}, {"BRX"},   {"JMP"},
                                                  {"JMX"}, {"BREAK"}, {"JMXU"}};

std::set<std::string> Instruction::opcode_call = {{"CAL"}, {"CALL"}};

// avoid Barrier Set Convergence Synchronization Point, SSY, BSSY
// TODO(Keren): add more sync instructions
std::set<std::string> Instruction::opcode_sync = {{"SYNC"}, {"BSYNC"}};

...
typedef struct hpctio_sys_func {
  ...
  int (*prefetch)(uint64_t startoff, uint64_t endoff, hpctio_obj_id_t * obj, hpctio_obj_opt_t * opt, hpctio_sys_params_t * p);
  size_t (*readat)(void * buf, size_t count, uint64_t offset, hpctio_obj_id_t * obj, hpctio_obj_opt_t * opt, hpctio_sys_params_t * p);

...
{
  ildmod_btuwi_pair_t* lsentinel =
	  ildmod_btuwi_pair_t_build(0, 0, NULL, NULL, m_alloc );
  ildmod_btuwi_pair_t* rsentinel =
	  ildmod_btuwi_pair_t_build(UINTPTR_MAX, UINTPTR_MAX, NULL, NULL, m_alloc );
  cskiplist_t *cskl =
	  cskl_new( lsentinel, rsentinel, maxheight,
		  ildmod_btuwi_pair_cmp, ildmod_btuwi_pair_inrange, m_alloc);
  return (cskl_ildmod_btuwi_t*)cskl;
}

ildmod_btuwi_pair_t*
cskl_ildmod_btuwi_cmp_find(cskl_ildmod_btuwi_t *cskl, ildmod_btuwi_pair_t* value)
{
  return (ildmod_btuwi_pair_t*)cskl_cmp_find((cskiplist_t*)cskl, value);
}

ildmod_btuwi_pair_t*
cskl_ildmod_btuwi_inrange_find(cskl_ildmod_btuwi_t *cskl, uintptr_t value)
{
  return (ildmod_btuwi_pair_t*)cskl_inrange_find((cskiplist_t*)cskl, (void*)value);
}
...
{
  return cskl_inrange_del_bulk_unsynch((cskiplist_t *)cskl, low, high, m_free);
}
	...
	char str[], int max_cskl_str_len)
{
  ...
  strncat(cskl_itpair_treeIndent, interval_ldmod_maxspaces(), MAX_CSKIPLIST_STR - indentlen -1);

  // print the binary tree with the proper indentation:
  char itpairstr[max_ildmod_btuwi_pair_len()];
  ildmod_btuwi_pair_t* node_val = (ildmod_btuwi_pair_t*)nodeval;
  ildmod_btuwi_pair_tostr_indent(node_val, cskl_itpair_treeIndent, itpairstr);
...
{
  cskl_tostr((cskiplist_t *)cskl, cskl_ildmod_btuwi_node_tostr, str, MAX_CSKIPLIST_STR);
}
...
cskl_ildmod_btuwi_print(cskl_ildmod_btuwi_t *cskl)
{
  ...
  cskl_ildmod_btuwi_tostring(cskl, cskl_buff);
  printf("%s", cskl_buff);
}
